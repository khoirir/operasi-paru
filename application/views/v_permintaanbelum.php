        ...
        <div class="panel panel-warning">
            <div class="panel-heading">
                ...
                <!-- <div class="heading-elements">
                    <a data-toggle="modal" data-target="#modal_form_horizontal">
                        <button type="button" class="btn btn-primary btn-xs heading-btn" style='background-color:#ffffff; color:#000000'><i class="icon-pencil7 position-left"></i>REGISTRASI PASIEN</button>
                    </a>
				</div>-->
            </div>
            ...
            "columnDefs": [
                ...
                },
                {
                    "render": function(data, type, row) {
                        var noregistrasi = row.noregop
                        var norm = row.norm
                        var html ="<a data-popup='tooltip' title='Konfirmasi Jadwal' data-toggle='modal' data-target='#modal_full' type='button' onclick=\"getDetail('" +noregistrasi +"');\" class='btn btn-primary btn-icon'><i class='glyphicon glyphicon-pencil'></i></a>";
                        return html;
                    },
                    "targets": [8],
                    "orderable": false,

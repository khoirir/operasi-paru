...
$(function() {
    ...
    $('.file-input').fileinput({
        ...
        browseClass: 'btn btn-xs btn-primary btn-labeled',
        browseIcon: '<b><i class="icon-file-plus"></i></b>',
        uploadIcon: '<i class="icon-file-upload2"></i>',
        removeLabel: 'HAPUS',
        removeClass: 'btn btn-xs btn-danger btn-labeled',
        removeIcon: '<b><i class="icon-cancel-square"></i></b>',
        layoutTemplates: {
            icon: '<i class="icon-file-check"></i>',
            modal: modalTemplate
        },
        initialCaption: "TIDAK ADA FILE DIPILIH",
